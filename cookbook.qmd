...
```bash
URL=https://github.com/anisotropi4/parenx/blob/main/data
voronoi.py ${URL}/rnet_doncaster_rail.geojson?raw=true sk-doncaster.gpkg
```
...
* The road network data are static extracts from OpenStreetMap under [CC-BY-SA 2.0](https://www.openstreetmap.org/copyright) through the [OverPassAPI Turbo service](https://overpass-turbo.eu/).
