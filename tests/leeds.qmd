...
```{r}
# Get raw data from https://github.com/nptscot/coherentnet/blob/main/data/osm_leeds.geojson
leeds = sf::read_sf("https://raw.githubusercontent.com/nptscot/coherentnet/main/data/osm_leeds.geojson")
names(leeds)
if (!file.exists("osm_leeds.geojson")) {
  download.file("https://raw.githubusercontent.com/nptscot/coherentnet/main/data/osm_leeds.geojson", "osm_leeds.geojson")
}
```
