...
plot_geodataframe_with_labels(gdf_matching_lines)
#########################################################################
...
plot_geodataframe_with_labels(gdf_split)
...
def plot_paths(gdf, paths, shortest_path):
    # Create a new figure
    fig, ax = plt.subplots(figsize=(10, 10))
...
plot_paths(gdf_split, all_paths, shortest_path)
...
def plot_lines_by_indices(gdf, line_indices_lists, colors):
    # Create a new figure
    fig, ax = plt.subplots(figsize=(10, 10))
...
plot_lines_by_indices(gdf_split, division_subpaths, ['blue', 'red'])
