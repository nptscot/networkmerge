...
We shortened “Joining route networks” to a concise note clarifying that attribute conflation is not part of `parenx` and was not used in the Edinburgh application, pointed readers to existing tools (`stplanr::rnet_merge()`, `rnetmatch`), and flagged a fuller evaluation of joining strategies as future work.
