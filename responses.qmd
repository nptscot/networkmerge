...
- [x] **R2.11** This may be in the appendix, which I haven't received, but the main text would also benefit from understanding the resolution of the raster component in skeletonization and the reasoning behind it. 
...
<!-- - [ ] **PDF2** "In detail, skeletonization is only applied where more than line-segment buffer overlaps."
