...
Inserted explicit references in the skeletonisation and Voronoi subsections to the corresponding columns of @fig-skeleton-line (Otley top row; Armley bottom row) to guide readers to concrete outputs.
