...
Similar to the previous comment, we have improved the flow of the paper by adding transitions and clarifying the connections between sections. We have also ensured that the text reads more smoothly and coherently.
...
- Rephrased the point-to-line reconstruction with a lead-in and tightened wording; noted it as the most complex stage.
- Introduced a contrastive lead for Voronoi ("In contrast to skeletonization…") and tightened the selection criteria for retained edges.
