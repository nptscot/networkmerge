...
The skeletonisation approach generates a simplified network by buffering the network, applying an image skeletonisation algorithm, and extracting lines segments from a raster of this buffer.
...
The skeletonisation algorithm is then applied to the raster image yielding a skeletal raster image, as shown in @fig-thin-skeleton.
