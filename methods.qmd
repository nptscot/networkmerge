...
Both input datasets were sourced from the Propensity to Cycle Tool (PCT) which in turn is based on OpenStreetMap (OSM) (see the '`parenx` cookbook', a technical appendix that accomanies this paper, for an example of the method applied to a rail network dataset).
