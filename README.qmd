...
#     value_sum = 0 # Sum of 'value' attributes for lines within the buffer
#     indices_within_buffer = [] # Indices of lines within the buffer
...
plot_buffer_with_lines(gdf_buffered, gdf, buffer_index=959, relation='intersect')
gdf_buffered.iloc[1477]['value_sum']
