...
nearest_lines = gdf['geometry'].apply(find_nearest_line, lines_df=gdf_road)
...
gdf_remove.loc[1, 'value'] += gdf_remove.loc[0, 'value']

# Remove Line 0
gdf_remove = gdf_remove.drop(0)

# Reset the index
gdf_remove = gdf_remove.reset_index(drop=True)
