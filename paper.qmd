...
The input datasets are presented in @tab-input-data.
...
input_data = tibble::tribble(
  ...
  "Otleys Road", 100, "A road in Leeds", "Propensity to Cycle Tool (derived from OSM)",
  "Armley Road", 100, "A road in Leeds", "Propensity to Cycle Tool (derived from OSM)"
  )
