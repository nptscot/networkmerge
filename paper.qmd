...
ax5.set_title('Neatnet Simplification')
...
Results of the route network simplification methods applied to Edinburgh city centre, comparing the input dataset (top), skeletonised network (second), Voronoi diagram (third), primal network (fourth), neatnet simplification (fifth) and ground truth network (sixth).
:::
