...
# Plot 5: Neatnet
ax5 = edinburgh_neatnet.plot(ax=ax5, color='black')
ax5.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax5.xaxis.set_ticklabels([])
ax5.yaxis.set_ticklabels([])
ax5.set_title('Neatnet Python package (artifact_threshold=5)')
ax5.set_xlim(xmin_t, xmax_t)
ax5.set_ylim(ymin_t, ymax_t)

# Plot 6: Ground truth ordnance survey data
ax6 = os_edinburgh.plot(ax=ax6, color='black')
ax6.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax6.xaxis.set_ticklabels([])
ax6.yaxis.set_ticklabels([])
ax6.set_title('Official Road Centrelines (Ordnance Survey OpenRoads)')
...
Results of the route network simplification methods applied to Edinburgh city centre, comparing the input dataset (top left), skeletonised network (top right), Voronoi diagram (middle left), primal network (middle right), neatnet simplification (bottom left) and ground truth network (bottom right).
:::
