...
affiliation: 
  - name: Leeds Institute for Transport Studies, University of Leeds, UK
    index: 1
  - name: Network Rail, UK
    index: 2
  - name: Environmental Systems Research Institute, Redlands, CA, USA
    index: 3
format:
  # pdf: default
  html: default
