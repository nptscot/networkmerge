...
Results of the route network simplification methods applied to Edinburgh city centre, comparing the input dataset (top left), skeletonised network (top right), Voronoi diagram (bottom left), and primal network (bottom right).
:::
