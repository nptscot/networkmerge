...
The two main methods developed in this paper are image skeletonization and Voronoi diagram-centreline identification, both of which are implemented in the open source software for reproducible research (see the reproducible source code of this paper at [github.com/nptscot](https://github.com/nptscot)).
Both methods result in geometries that are substantially simpler and less resource-intensive for subsequent network analysis steps, while preserving the essential connectivity and spatial characteristics of the original network.
...
There are several future directions of travel that could build on this work.
