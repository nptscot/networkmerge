...
See the ['`parenex` cookbook'](https://nptscot.github.io/networkmerge/cookbook.html) and [Methods](https://nptscot.github.io/networkmerge/methods.html) appendices for details on the methods used in this paper and their application to alternative (railway based) datasets.
...
The skeltonisation algorithm is then appled to the raster image yielding a skeletal raster image and converted back into a linear vector geometry, completing the vector-to-raster-to-vector geometry transformation (see the [Methods](https://nptscot.github.io/networkmerge/methods.html) appendix for details).
