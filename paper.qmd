...
In this study, we focus on two exemplary input datasets, as outlined in @tbl-input-data, both of which are sourced from the Propensity to Cycle Tool (PCT). The PCT derives its data from OpenStreetMap (OSM), each illustrating varying levels of complexity. This variety allows us to explore and understand the nuances involved in simplifying route networks for more efficient urban transport planning.
...
@fig-otley-armley-classes shows the segmented buffer geometries of the Otley Road (left) and Armley Road (right) networks. It effectively highlights the contrast between the more intricate and the simpler sections within these networks.
...
@fig-segment showcase the conversion of segmented LineString geometries into point geometries. This essential transformation forms the basis for constructing Voronoi diagrams. 
...
@fig-voronoi-point, the process of converting the segmented LineString geometries into point geometries is illustrated. This transformation is essential for the creation of Voronoi diagrams.
...
The center-line network depicted in @fig-voronoi-line is created through a process that involves the removal of knot-like features from the resultant network. This step refines the geometry of network, ensuring a more streamlined and accurate representation of the transport routes.
...
# Results - Comparative Analysis of Simplified Route Networks

In this section, we present a comparative analysis of the results from the applied simplification techniques across different routes. The section is organized in a matrix format, displaying results from three distinct locations: Armley, Edinburgh, and Doncaster rail. Each column is dedicated to one of these locations, and the rows are organized to showcase different stages of network simplification, providing a systematic and comparative view of the impact of methodology.

*Results Organization*

- Row 1 - Input：
This row presents the initial input geometries for each location, serving as the baseline for comparing subsequent simplification stages.

- Row 2 - Skeletonized：
The second row shows the results of the skeletonization process, reducing the networks to their fundamental linear structures.

- Row 3 - Voronoi：
Here, we display the outcomes of applying the Voronoi diagram-based simplification, focusing on the central alignment of the routes.

- Row 4 - Primal Skeletonized：
This row demonstrates the networks post-application of a primal approach to the skeletonized data, offering insights into the primary routes and connections.

- Row 5 - Primal Voronoi：
The final row exhibits the results of applying a primal approach to the Voronoi-simplified networks, highlighting the straightforward paths within the Voronoi framework.
...
ax = base_armley.plot(color='blue')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
ax.set_ylabel('Input', rotation=0, size='large', labelpad=40)
```

```{python}
# 1 2
ax.figure.set_size_inches(10, 10)
ax = base_edinburgh.plot(color='blue')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 1 3
ax.figure.set_size_inches(10, 10)
ax = base_doncaster.plot(color='blue')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 2 1
ax.figure.set_size_inches(10, 10)
ax = armley_sk.plot(color='green')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
ax.set_ylabel('Skeletonized', rotation=0, size='large', labelpad=40)
```

```{python}
# 2 2
ax.figure.set_size_inches(10, 10)
ax = edinburgh_sk.plot(color='green')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 2 3
ax.figure.set_size_inches(10, 10)
ax = doncaster_sk.plot(color='green')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 3 1
ax.figure.set_size_inches(10, 10)
ax = armley_line.plot(color='orange')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
ax.set_ylabel('Voronoi', rotation=0, size='large', labelpad=40)
```

```{python}
# 3 2
ax.figure.set_size_inches(10, 10)
ax = edinburgh_line.plot(color='orange')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 3 3
ax.figure.set_size_inches(10, 10)
ax = doncaster_line.plot(color='orange')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 4 1 Voronoi
ax.figure.set_size_inches(10, 10)
ax = armley_edge_sk.plot(color='orchid')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
ax.set_ylabel('Primal Skeletonized', rotation=0, size='large', labelpad=40)
```

```{python}
# 4 2
ax.figure.set_size_inches(10, 10)
ax = edinburgh_edge_sk.plot(color='orchid')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 4 3
ax.figure.set_size_inches(10, 10)
ax = doncaster_edge_sk.plot(color='orchid')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 5 1 Voronoi primal
ax.figure.set_size_inches(10, 10)
ax = armley_edge.plot(color='tomato')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
ax.set_ylabel('Primal Voronoi', rotation=0, size='large', labelpad=40)
```

```{python}
# 5 2
ax.figure.set_size_inches(10, 10)
ax = edinburgh_edge.plot(color='tomato')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
...
# 5 3
ax.figure.set_size_inches(10, 10)
ax = doncaster_edge.plot(color='tomato')
ax.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax.xaxis.set_ticklabels([])
ax.yaxis.set_ticklabels([])
```
