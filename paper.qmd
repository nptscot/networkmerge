...
In this section, we delve into the practical application of our proposed route network simplification techniques, focusing on a complex urban road network situated in the heart of Edinburgh. @tbl-new-datasets presents the key characteristics of the Edinburgh city centre, offering insights into its geometric structure and complexity.
...
@fig-results presents different stages of network simplification, providing a comparative view of the impact of methodology.
