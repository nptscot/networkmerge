...
Once we obtained  the rnet_merged dataset, which is a simplied network but alos contians detials attrivbutes. We then need a series of steps to refine the data.
