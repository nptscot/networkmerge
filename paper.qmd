...
The primal network in figure @fig-results is a highly simplified network created by connecting intersecting or end nodes, removing intermediate points and sections within linear features.
