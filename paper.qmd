...
Geographic file formats implementing the 'simple features' standard described in [ISO 19125-1:2004](https://www.iso.org/standard/40114.html), such as `.shp` and `.geojson`, can also be used to represent route networks.
