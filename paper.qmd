...
The rasterized skeletal image is then converted back into point geometry, completing the vector -> raster -> vector geometry transformation process, as illustrated in @fig-skeleton-vector.
