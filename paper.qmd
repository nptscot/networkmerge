...
# Plot 2: Skeletonised
ax2 = edinburgh_sk.plot(ax=ax2, color='black')
ax2.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax2.xaxis.set_ticklabels([])
ax2.yaxis.set_ticklabels([])
ax2.set_title('Skeletonised')
ax2.set_xlim(xmin_t, xmax_t)
ax2.set_ylim(ymin_t, ymax_t)

# Plot 3: Voronoi
ax3 = edinburgh_line.plot(ax=ax3, color='black')
...
# Plot 4: Primal Skeletonised
ax4 = edinburgh_edge_sk.plot(ax=ax4, color='black')
...
# Plot 5: Ground truth ordnance survey data
ax5 = os_edinburgh.plot(ax=ax5, color='black')
ax5.grid(True, color='grey', linestyle='--', linewidth=0.5)
ax5.xaxis.set_ticklabels([])
ax5.yaxis.set_ticklabels([])
ax5.set_title('Ground Truth (Ordnance Survey)')
ax5.set_xlim(xmin_t, xmax_t)
ax5.set_ylim(ymin_t, ymax_t)
add_scalebar(ax5, loc='lower center', pad=0.6)
...
Results of the route network simplification methods applied to Edinburgh city centre, comparing the input dataset (top), skeletonised network (second), Voronoi diagram (third), primal network (fourth) and ground truth network.
:::
