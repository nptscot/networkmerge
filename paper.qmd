...
These models, enriched through graph theory, enclosed the complex, multi-modal nature of transportation data across various jurisdictions \[\^2\].
...
One is to explore alternative algorithms for thinning buffered networks, for example the grassfire algorithm [@leymarie1992].
