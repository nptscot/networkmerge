...
-   Packaging the approach in open source software products that are easy to use and integrate in other tools, for the benefit of open source transport planning in general

-   Testing the impact of different parameters to find appropriate settings for different use cases

-   Optimisation, noting that premature optimisation has been described as the "root of all evil"[^1]
