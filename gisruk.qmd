...
The rasterized skeletal image is then converted back into point geometry, completing the vector -\> raster -\> vector geometry transformation process, as illustrated in @fig-skeleton-line.
...
From these sequences, a centre-line is derived based on a set of Voronoi polygons that cover these points which represents the central line of the network.
...
The clipped Voronoi representation and the resulting central lines are illustrated in @fig-voronoi-2 and @fig-fig-voronoi-line, respectively.
...
-   Optimisation, which may have been described as the 'root of all evil', but which is important for working with national or global datasets
