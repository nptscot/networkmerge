...
# gdf_centroids.to_file(f"data/gdf_centroids_{len}m.geojson", driver='GeoJSON')
gdf_centroids.head()
```
...
gdf_road_simplified_updated.to_file(f"data/gdf_road_simplified_updated_{len}m.geojson", driver='GeoJSON')
